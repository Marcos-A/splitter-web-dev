...
<?php 
    ...
    # Uncomment in case of PHP error to get the error message code while debugging:
    # https://www.php.net/manual/en/features.file-upload.errors.php
    /* if(array_key_exists('actaToUpload', $_FILES)){
        if ($_FILES['actaToUpload']['error'] === UPLOAD_ERR_OK) {
            echo 'upload was successful';
        } else {
            die("Upload failed with error code " . $_FILES['actaToUpload']['error']);
        }
    } */
...
<?php
    ...
    # Uncomment in case of PHP error to get the error message code while debugging:
    # https://www.php.net/manual/en/features.file-upload.errors.php
    /* if(array_key_exists('butlletinsToUpload', $_FILES)){
        if ($_FILES['butlletinsToUpload']['error'] === UPLOAD_ERR_OK) {
            echo 'upload was successful';
        } else {
            die("Upload failed with error code " . $_FILES['butlletinsToUpload']['error']);
        }
    } */
